...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiBriefcase, FiLayers } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'administrator', 'product-manager', 'team-member'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Feature', path: '/features', entity: 'feature', service: AccessServiceEnum.PROJECT, icon: FiLayers },
